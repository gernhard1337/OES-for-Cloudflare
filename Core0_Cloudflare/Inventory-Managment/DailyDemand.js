import {eVENT} from "../OESjs-Core0/OES-Foundation";
import {getUniformRandomInteger} from "../lib/math";
import {Delivery} from "./Delivery";

export class DailyDemand extends eVENT {
    ...
    static quantity() {
        return getUniformRandomInteger( 5, 30);
    }
    static recurrence() {
        return 1;
    }
